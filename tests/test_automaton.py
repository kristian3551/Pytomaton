...
def test_left_arrow():
    ...
    a.add_transition('2', 'b', '2')
    a.add_transition('2', 'a', '2')
    assert a.left_arrow('0').accepts_word('aaaaaaaaaa')
    assert a.left_arrow('1').accepts_word('aaaaaaaaaabbbbbbbbbbb')
    assert not a.left_arrow('1').accepts_word('aaaaaaaaaabbbba')
...
def test_right_arrow():
    ...
    a.add_transition('2', 'b', '2')
    a.add_transition('2', 'a', '2')
    assert a.right_arrow('0').accepts_word('aaaaaaaaaabbbbbbbbbbbb')
    assert a.right_arrow('1').accepts_word('bbbbbbbbbbb')
    assert not a.right_arrow('1').accepts_word('aaaabbbb')